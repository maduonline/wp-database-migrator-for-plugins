...
class WPDbMigrations {
    ...
    private function setAttributes() {
        global $wpdb;
        $this->DB_TABLE_PREFIX = $wpdb->prefix . $this->PLUGIN_TABLE_PREFIX;
    ...
    private function runDbMigration_10() { // create first tables
        $sql1 = "CREATE TABLE " . $this->DB_TABLE_PREFIX . "test_table (
    ...
    private function runDbMigration_11() { // create first tables
        $sql1 = "CREATE TABLE " . $this->DB_TABLE_PREFIX . "test_table2 (
		id mediumint(9) NOT NULL AUTO_INCREMENT,
		name tinytext NOT NULL,
		email text NOT NULL,
		UNIQUE KEY id (id)
